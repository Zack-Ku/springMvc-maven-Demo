...
@javax.persistence.Table(name = "user", schema = "springDEMO", catalog = "")
public class UserEntity {
    ...
    @javax.persistence.Column(name = "nickname", nullable = false, length = 45)
    ...
    @javax.persistence.Basic
    @javax.persistence.Column(name = "password", nullable = false, length = 45)
    ...
    @javax.persistence.OneToMany(cascade = {}, mappedBy = "userByUserId")
